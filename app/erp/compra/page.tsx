        ...
        <div className="w-full flex flex-col p-8">
            <div className='flex items-center justify-center w-1/3'>
                <div className='w-1/3 mr-2'>
                    <InputCommon titulo={"Codigo"} tipo={'text'} placeholder={""} texto={codProveedor} seleccionar={setCodProveedor}/>
                </div>
                <div className='w-2/3'>
                    <ComboBoxSelect titulo={"Proveedor"} data={people} seleccionado={codProveedor} setearCodigo={setCodProveedor}/>
                </div>
            </div>
