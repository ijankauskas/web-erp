      ...
      <Combobox as="div" value={selectedPerson} onChange={seleccionarOpcion} {...useForm}>
        ...
        <div className="relative mt-1">
          ...
          {filteredPeople?.length > 0 && (
            <Combobox.Options className="absolute z-888 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
