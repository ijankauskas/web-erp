...
export default function PaginadoComp({ pagina, cambiarPagina, cliente }: any) {
    ...
    async function cargarComponente() {
        const respuesta = await DbSaldosClientes('total_comp_emitidos', null, null, null, null, cliente.codigo);
