...
const CheckDepositos = ({ register, setValue, clearErrors, errors, getValues, watch }: any) => {
        ...
        <div className="mt-5 md:mt-0 md:col-span-2">
            <div className="">
                <div className="py-5">
                    <ToggleSwitch
                        label={"Activo"}
                        description={"Si desactivas el deposito no podras verlo."}
