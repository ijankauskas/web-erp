...
export default function InputCommon({ titulo, tipo, id, placeholder, texto, onChange, funcionOnblur, error, useForm, step, textAlign = 'text-start', desactivado, paddingY = 'py-1.5' }: any) {
